  ...
  return (
    <section id="work" className="c-space py-24 md:py-32">
      ...
      <div className="mt-16 md:mt-20 flex flex-col items-center text-center">
        <div className="glass-card p-8 md:p-12 max-w-2xl w-full group hover:border-accent-blue/50 transition-all duration-500">
          <a
            href="https://github.com/Nferreira0804?tab=repositories"
            target="_blank"
            rel="noreferrer"
            className="flex flex-col items-center gap-6"
          >
            <div className="w-16 h-16 rounded-full glass-pill border-white/10 flex items-center justify-center group-hover:bg-accent-blue/20 group-hover:scale-110 transition-all duration-500">
              <img
                src={`${import.meta.env.BASE_URL}assets/logos/github.svg`}
                alt="GitHub"
                className="w-8 h-8 opacity-60 group-hover:opacity-100 transition-all duration-500"
              />
            </div>
            <p className="text-lg md:text-xl text-neutral-300 font-outfit font-light leading-relaxed group-hover:text-white transition-colors">
              Aquí tengo sistemas <span className="text-accent-blue font-semibold">open-source</span> que les puede ser de utilidad
            </p>
            <span className="text-sm text-neutral-500 font-outfit group-hover:text-accent-blue transition-colors">
              Ver repositorios →
            </span>
          </a>
        </div>
